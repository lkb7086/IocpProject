...
class NETLIB_API CSHA512 final : public CSingleton
{
	DECLEAR_SINGLETON(CSHA512);
protected:
...
CREATE_FUNCTION(CSHA512, SHA512)
...
const string& hash = sha512("abcdef"); // const를 붙이면 임시객체의 생명주기가 증가
printf("%s\n", hash.c_str());
cout << hash << endl;
*/